        ...
        <section className="mb-12">
          <div className="bg-gradient-to-r from-teal-50 to-emerald-50 p-8 rounded-xl">
            ...
            <p className="text-lg text-gray-700 leading-relaxed mb-4">
              Rocky Mountain Great Dane Rescue, Inc. is a group of volunteers passionate about the welfare of Great Danes. Since our inception in 2000, our mission is rescuing, rehabilitating, and rehoming Great Danes and Dane mixes throughout the Rocky Mountain region. We strive to find new, permanent, and loving homes for these Danes with the end goal of lowering euthanasia rates in our region. We help those that have been abused, abandoned, neglected, or through no fault of their own, just need to find a new forever home.
            </p>
