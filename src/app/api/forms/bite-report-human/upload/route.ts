...
/**
 * POST /api/forms/bite-report-human/upload
 *
...
export async function POST(req: NextRequest) {
  ...
  try {
    const key = generateKey("rmgdri-media/incident/bite-report", file.name);
    ...
    console.error("[bite-report-human/upload] R2 error:", e?.message ?? e);
    return NextResponse.json(
