      ...
      <div className="max-w-6xl mx-auto px-6 py-12">
        ...
        <section className="mb-16">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              {/* CTA Button */}
              <div className="bg-gradient-to-r from-teal-50 to-blue-50 p-6 rounded-xl text-center">
        ...
        <section className="mb-12">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            {/* More Opportunities */}
            <div className="bg-gradient-to-br from-teal-50 to-blue-50 border-2 border-teal-300 rounded-xl p-6 flex flex-col justify-center items-center text-center shadow-lg">
